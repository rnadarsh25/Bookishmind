<?php
    ...
    if(isset($_GET['edit_id'])){
            ...
            while($row = mysqli_fetch_assoc($fetch_record_query)){
                ...
                $record_author_id = $row['record_author_id'];
            }
...
<div class="form-group">
    <label for="record_image">Novel Image</label><br>
    <img src="../images/<?php echo $record_image;?>" alt="" width="100" height="100">
</div>

<div class="form-group">
    <label for="record_image">Choose New Novel Image</label>
...
<div class="form-group">
    <input type="submit" name="update_record" value="Update Novel"  class="btn btn-success btn-md">
</div>
